<div class="primary-screen" style="background-image: url('/public/img/backgrounds/certificates_primary-screen.jpg');">
    ...
    <div class="primary-screen__container container">
        ...
        <div class="primary-screen__body" data-aos="fade-up">
            ...
            <h1 class="h1 h1_page_primary-screen">Подарочные сертификаты</h1>
        </div>
